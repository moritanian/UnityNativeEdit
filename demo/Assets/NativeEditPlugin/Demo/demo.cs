...
public class demo : MonoBehaviour {
	...
	void Start () {
		...
		tempNB.returnKeyType = NativeEditBox.ReturnKeyType.Default;
		tempNB.verticalScrollbarEnabled = true;
...
//		testNativeEdit.SetFocusNative(bTempFocus);
	...
	{
		testNativeEdit.SetVerticalScrollOffset (0);
	}
...
//		testNativeEdit.SetTextNative("TestText Set!!@#@5");
			...
			StreamWriter sw;
			FileInfo fi;
			string path = Application.persistentDataPath + "/" + "demo.txt";
